...
public class DataFrame {
	...
	public enum OPERATION {
		...
		STOP, STOPTIMER, TIMER_10, TIMER_20, TIMER_30, FATIGUERECOVERY_ON, FATIGUERECOVERY_OFF,
		/**
		 * pain ease
		 */
		...
		PRESSURE_MANUAL_OFF,
		// SPEED
		PRESSURE_SPEED_1, PRESSURE_SPEED_2, PRESSURE_SPEED_3,
		/**
		 * BRACE
		 */
		// LEG
		 ...
		 * heat 
		 */
		THEMALMETHOD_ON, THEMALMETHOD_OFF,THERMALFEET_OFF,THERMALFEET_ON,
		/**
		 * shoulder height
		 */
