...
//				arg0.setVisibility(View.VISIBLE);
				imgRightDrawerBar.setVisibility(View.VISIBLE);
			}
			...
			public void onDrawerOpened(View arg0) {
				// TODO Auto-generated method stub
				Log.d(TAG2, "-----"+arg0.getId());
//				imgRightDrawerBar.setVisibility(View.GONE);
//				mViewCome.run();
				if(!mPower){mImageZeroGravity.setSelected(false);
...
//			popWindow.setFocusable(true);
	...
	private void popupModeListView(){
		LayoutInflater inflater=getLayoutInflater();
		View view=inflater.inflate(R.layout.op_mode_pop_view, null);
		mListView_mode=(ListView)view.findViewById(R.id.lv_mode);
		...
		SimpleAdapter adapter=new SimpleAdapter(this, mode_ListItem, R.layout.op_mode_list_item,
								new String[]{"ItemImage","ItemTitle"}, 
								new int[]{R.id.img_mode_item,R.id.tv_mode_item});
		mListView_mode.setAdapter(adapter);
//		PopupWindow popupModeWindow=new PopupWindow(view, 187, 268);
//		popupModeWindow.setBackgroundDrawable(new ColorDrawable(android.R.color.white));
//		popupModeWindow.setOutsideTouchable(true);
//		popupModeWindow.showAsDropDown(btn_pressure, 0, 2);
		mListView_mode.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
				   ...
				   Log.d(TAG2, "----listview  arg0="+arg0+"View ="+arg1);
	            ((ListView)arg0).setTag(arg1);
	            arg1.setBackgroundResource(R.drawable.bk_auto_list);
				if(mode_ListItem.get(arg2).get("ItemTitle").equals(getString(R.string.knead)))
                { 
//					 setPartLvImg(mListView_mode,arg2, R.drawable.op_img_rounie_active);
					 Log.d(TAG2, "----rounie img");
					 sendCommand(DataFrame.getSendFrame(OPERATION.BACK_KNEADING_ON));
				...
				if(mode_ListItem.get(arg2).get("ItemTitle").equals(getString(R.string.rap)))
                {
					...
					threeDFlag=false;
					mModeOn=true;
//					 setPartLvImg(mListView_mode,arg2, R.drawable.op_img_kouji_active);
                }
				if(mode_ListItem.get(arg2).get("ItemTitle").equals(getString(R.string.pat)))
                {
					sendCommand(DataFrame.getSendFrame(OPERATION.BACK_CLAPPING_ON));
					...
					threeDFlag=false;
					mModeOn=true;
//					 setPartLvImg(mListView_mode,arg2, R.drawable.op_img_paida_acitve);
                }
				if(mode_ListItem.get(arg2).get("ItemTitle").equals(getString(R.string.knead_knock)))
                {
					sendCommand(DataFrame.getSendFrame(OPERATION.BACK_KNEADING_TAPPING_ON));
...
//					setPartLvImg(mListView_mode,arg2, R.drawable.op_img_zhiya_active);
	...
	private void setManualList(){
        ...
        HashMap<String, Object> map = new HashMap<String, Object>();  
        map.put("ItemImage", R.drawable.op_manual_mode_normal);//图像资源的ID  
        map.put("ItemTitle", getResources().getString(R.string.mode));  
        map.put("arrow", R.drawable.op_manual_arrow);
        manual_ListItem.add(map); 
        
        map = new HashMap<String, Object>();  
        map.put("ItemImage", R.drawable.op_manual_part_normal);//图像资源的ID  
        map.put("ItemTitle", getResources().getString(R.string.part));  
        map.put("arrow", R.drawable.op_manual_arrow);
        manual_ListItem.add(map); 
        
        map = new HashMap<String, Object>();  
        map.put("ItemImage", R.drawable.op_manual_width_normal);//图像资源的ID  
        map.put("ItemTitle", getResources().getString(R.string.width)); 
        map.put("arrow", R.drawable.op_manual_arrow);
        manual_ListItem.add(map); 
        
        map = new HashMap<String, Object>();  
        map.put("ItemImage", R.drawable.op_manual_speed_normal);//图像资源的ID  
        map.put("ItemTitle", getResources().getString(R.string.speed)); 
        map.put("arrow", R.drawable.op_manual_arrow);
        manual_ListItem.add(map); 
        
        map = new HashMap<String, Object>();  
        map.put("ItemImage", R.drawable.op_manual_3d_normal);//图像资源的ID  
        map.put("ItemTitle", getResources().getString(R.string.threeD)); 
        map.put("arrow", R.drawable.op_manual_arrow);
        manual_ListItem.add(map); 
        
        //生成适配器的Item和动态数组对应的元素  
        SimpleAdapter listItemAdapter = new SimpleAdapter(this,manual_ListItem,//数据源   
            R.layout.op_manual_list_item,//ListItem的XML实现  
            //动态数组与ImageItem对应的子项          
...
//					setShiatsuState(b);
			...
			case 11:
				if ((byte) ((b >> 1) & 0x1) == 1 && AutoShoulderFlag==0) {
					AutoShoulderFlag=1;
//					RokolUtil.showToast(getApplicationContext(), "正在检测肩高……", 1);
